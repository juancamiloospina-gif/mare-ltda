...
- Selector visual por especie con Bovinos y Equinos.
- Bloque editorial de respaldo MSD y acompañamiento técnico.
- Catálogo visual con filtros decorativos, seis productos de ejemplo y fichas expandibles sin conexión real.
- Asesoría técnica con tres pilares y llamada a WhatsApp.
- Carrusel manual y tarjetas para las cuatro sedes con enlaces estáticos.
- Área B2B con beneficios y formulario demostrativo sin envío.
- Selector flotante de WhatsApp para las cuatro sedes.
...
- Composición editorial con bloques amplios, bordes sobrios y detalles geométricos inspirados en el isotipo.
...
- Comentarios `TODO: conectar backend` en filtros, fichas, cotización, buscador y formulario.
- Metadatos propios de MARE y comportamiento adaptable a móvil y escritorio.
- Verificación final visual en escritorio y móvil, incluyendo ausencia de solapamientos y respeto por movimiento reducido.
